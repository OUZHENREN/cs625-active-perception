...
def generate_launch_description():
    ...
    arguments = [
        ...
        DeclareLaunchArgument("launch_moveit", default_value="true", description="Start MoveIt from sim_base; P7 may gate it on active controllers."),
        ...
        DeclareLaunchArgument("initial_positions_file", default_value=PathJoinSubstitution([FindPackageShare("eli_cs_robot_description"), "config", "initial_positions.yaml"]), description="Joint positions used to initialize the simulated robot."),
        DeclareLaunchArgument("initial_detach", default_value="false", description="Publish one DetachableJoint detach command after robot spawn."),
        DeclareLaunchArgument("initial_detach_topic", default_value="/p7/attachment/detach", description="Absolute Gazebo transport detach topic."),
